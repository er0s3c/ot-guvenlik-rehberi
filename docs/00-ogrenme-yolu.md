...
| 3 | Süreç ve sektör | [Sektör karşılaştırması](02-sektorler/05-sektor-karsilastirmasi.md), [risk, emniyet ve bağımlılıklar](01-temeller/05-risk-emniyet-ve-bagimliliklar.md), [petrol ve kimya](02-sektorler/05-petrol-gaz-ve-kimya.md) ve seçilen sektör | Hizmeti kaybetmenin üç sonucunu ve bağımlılıklarını çiz |
| 4 | Tehdit modelleme | [Saldırgan bakışı](03-tehdit-modelleme/01-saldirgan-bakis-acisi.md), [sektörel senaryolar](02-sektorler/senaryolar/README.md), [vakalar](03-tehdit-modelleme/03-gercek-vakalar.md) | Bir olayda doğrulanmış bulgu ile olası sonucu ayır; 7 boyutlu savunma kartı çıkar |
