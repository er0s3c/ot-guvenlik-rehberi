...
| 6 — Protocol Inventory | [AK/varlık], [protokol/profil/sürüm], [taşıma/port veya uygulanamaz], [işlem amacı], [kimlik/şifreleme durumu], [kaynak] | Porttan çıkarım ile doğrulanmış protokol ayrılmış; bütün protokollere TCP portu atanmamış | [Protokol kataloğu](../docs/07-protokoller/01-protokol-katalogu.md) |
